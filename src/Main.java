...
public class Main {
     ...
     System.out.println("8 : Flow network");
         ...
         switch (n) {
                 ...
                 while (!stop) {
                     ...
                     switch (kindOfGraf) {
                         ...
                         case 2:
                             ...
                             else grafCreate.put(grafName, new UndirectedGraf(saTab));
                             break;
             ...
             case 2 -> {
                 ...
                 while (!stop) {
                     ...
                     switch (grafToModify) {
                         ...
                         case 5 -> stop = true;
                         default -> System.out.println("Unknown command, enter a valid command : ");
                     }
                     System.out.println();
                 }
                 stop = false;
             ...
             case 3 -> {
                 ...
                 while (!stop) {
                     ...
                     switch (grafToModify) {
                         case 1 -> System.out.println("Graph " + grafName + " has " + grafCreate.get(grafName).nbNodes() + " node(s).");
                         case 2 -> {
                         ...
                         case 6 -> System.out.println("Graph " + grafName + " has " + grafCreate.get(grafName).nbEdges() + " edges");
                         case 7 -> {
             ...
             case 8 -> {
                 System.out.println("The following programm will clear the ./resources/output directory.");
                 System.out.println("Please, remove the desired files before continuing");
                 System.out.println("Do you want to continue ? y / n");
                 String s = reader.next();
                 if (!s.equals("y")) {
                     System.out.println("Flow network abandoned");
                     break;
                 }

                 System.out.println("Give the graph name (it must be in input folder):");
                 grafName = reader.next();
                 File f = new File("./resources/input/" + grafName + ".dot");
                 FlowNetwork flowNetwork = new FlowNetwork(f);
                 flowNetwork.fordFulkerson();
                 System.out.println("File are created, check in ./resources/output folder.");
             }
